...
这里将分享两段代码，说明如何在 emacs 24 中异步安装 packages （我想大部分人都有等待 list-packages 命令的经历，在 emacs 25 里面已经解决了这个问题，但对于目前使用 emacs 24 的同学，这篇 blog 还是有好处的。）
